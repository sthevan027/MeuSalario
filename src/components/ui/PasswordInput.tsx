      ...
      <div className="w-full">
        <div className="relative">
          <input
            ...
            className={`w-full rounded-xl border bg-slate-800/50 px-4 py-3 pr-12 text-white placeholder:text-slate-500 transition-all focus:outline-none focus:ring-2 ${
              error
